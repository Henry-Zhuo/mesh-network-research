...
TypeId
TcpEchoClient::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::TcpEchoClient")
            ...
            .AddAttribute(
                ...
                UintegerValue(100),
                MakeUintegerAccessor(&TcpEchoClient::SetDataSize, &TcpEchoClient::GetDataSize),
                MakeUintegerChecker<uint32_t>())
            .AddTraceSource("Tx",
            ...
            .AddTraceSource("Rx",
                            ...
                            MakeTraceSourceAccessor(&TcpEchoClient::m_rxTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("TxWithAddresses",
                            "A new packet is created and is sent",
                            MakeTraceSourceAccessor(&TcpEchoClient::m_txTraceWithAddresses),
                            "ns3::Packet::TwoAddressTracedCallback")
            .AddTraceSource("RxWithAddresses",
                            "A packet has been received",
                            MakeTraceSourceAccessor(&TcpEchoClient::m_rxTraceWithAddresses),
                            "ns3::Packet::TwoAddressTracedCallback");
    return tid;
}
...
void
TcpEchoClient::StartApplication()
{
    NS_LOG_FUNCTION(this);
...
uint32_t
TcpEchoClient::GetDataSize() const
{
    NS_LOG_FUNCTION(this);
    return m_size;
}
...
TcpEchoClient::Send()
{
    ...
    if (m_dataSize)
    {
        ...
        NS_ASSERT_MSG(m_dataSize == m_size,
                      "TcpEchoClient::Send(): m_size and m_dataSize inconsistent");
