 ...
 */
TcpTraceClient::TraceEntry TcpTraceClient::g_defaultEntries[] = {
    {0, 534, 'I'},
    {40, 1542, 'P'},
    {120, 134, 'B'},
    {80, 390, 'B'},
...
TypeId
TcpTraceClient::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::TcpTraceClient")
            ...
            .AddAttribute("TraceLoop",
                          ...
                          BooleanValue(true),
                          MakeBooleanAccessor(&TcpTraceClient::SetTraceLoop),
                          MakeBooleanChecker())
...
TcpTraceClient::TcpTraceClient(Ipv4Address ip, uint16_t port, char* traceFile)
{
    NS_LOG_FUNCTION(this);
    m_sent = 0;
    m_socket = nullptr;
...
void
TcpTraceClient::SetRemote(Address addr)
{
...
uint16_t
TcpTraceClient::GetMaxPacketSize()
{
    NS_LOG_FUNCTION(this);
...
void
TcpTraceClient::LoadDefaultTrace()
{
    NS_LOG_FUNCTION(this);
    uint32_t prevTime = 0;
...
void
TcpTraceClient::StartApplication()
{
    NS_LOG_FUNCTION(this);
...
TcpTraceClient::Send()
{
    ...
    {
        m_sendEvent =
            Simulator::Schedule(MilliSeconds(entry->timeToSend), &TcpTraceClient::Send, this);
    }
}

void
TcpTraceClient::SetTraceLoop(bool traceLoop)
{
