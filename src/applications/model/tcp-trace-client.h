 ...
 */
class TcpTraceClient : public Application
{
  public:
    /**
     ...
     * \param port the destination tcp port to which the stream will be sent
     ...
     *
     */
    TcpTraceClient(Ipv4Address ip, uint16_t port, char* traceFile);
    ~TcpTraceClient() override;
